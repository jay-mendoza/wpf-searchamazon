...
namespace JayWpf.Services.Configuration
{
    ...
    public class WindowConfig
    {
        ...
        public void Load()
        {
            ...
            this.WindowSize.Width = double.Parse(size[0]);
            this.WindowSize.Height = double.Parse(size[1]);

            string[] position = ConfigurationManager.AppSettings.Get("position").Split(',');
            this.WindowPosition.Top = double.Parse(position[0]);
            this.WindowPosition.Left = double.Parse(position[1]);
        ...
        public class Theme
        {
            ...
            public enum Shades
            {
                ...
                /// <summary>Dark Alpha window scheme.</summary>
                DARKALPHA,

                /// <summary>Light window scheme.</summary>
                LIGHT,

                /// <summary>Light Alpha window scheme.</summary>
                LIGHTALPHA,
            }
